...
public enum NotificationSubCategory {
    ...
    CONTENT_UN_ENROLLED(NotificationCategory.LEARN,"You have successfully unenrolled from '{courseName}'."),
    CONTENT_RE_ENROLLED(NotificationCategory.LEARN,"You have successfully reenrolled in '{courseName}'.");
